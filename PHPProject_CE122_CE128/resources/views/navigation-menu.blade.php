            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @if (auth()->user()->role_id == 2)
                        <x-jet-nav-link href="{{ route('student.exams.index') }}" :active="request()->routeIs('student.exams.index')">
                            {{ __('Exams') }}
                        </x-jet-nav-link>
                    @endif
                    ...
                    @if (auth()->user()->role_id == 3)
                        ...
                        <x-jet-nav-link href="/result/result" :active="request()->routeIs('teacher.courses.index')">
                            {{ __('Results') }}
                        </x-jet-nav-link>
                    @endif
                </div>
